...
SELECT *  FROM usuario where id = 12;
select * FROM usuario where persona_id = 15;
DELETE FROM usuario where id = 15;
DELETE FROM persona where id = 15;

-- Eliminar registro en dependencia de primary key
SELECT * FROM persona WHERE id = 16;
SELECT * FROM usuario WHERE id = 16;
DELETE FROM usuario WHERE persona_id = (SELECT id FROM persona WHERE id = 16);
DELETE FROM persona WHERE id = 16;
